...
class App:
    ...
    def main(self):
        ...
        self.selected_stock_name = st.selectbox('Select Stock', ["Enter Symbol"] + (self.selected_region_data["Symbol"] + " - " + self.selected_region_data["Name"].str.slice(stop=50)))     

        if selection == "Enter Symbol": 
