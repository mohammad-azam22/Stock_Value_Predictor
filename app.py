    ...
    def getMovingAvg(self):
        if not self.data.empty:
            ...
            with _lock:
                ...
                plt.plot(mov_avg_50, "Red", label="50 day moving avg", alpha=0.6)
                plt.plot(mov_avg_100, "Yellow", label="100 day moving avg", alpha=0.6)
                plt.plot(mov_avg_200, "Green", label="200 day moving avg", alpha=0.6)
                plt.plot(self.data["Close"], "Blue", label="Stock Closing Price", alpha=0.6)
